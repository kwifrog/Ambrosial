...
public class AmbrosialItems {
    ...
    public static final RegistryObject<Item> KIWI_SEED = RegistryHandler.ITEMS.register("kiwi_seeds", () -> new SeedItem(AmbrosialBlocks.KIWI_CROP.get(), new Item.Properties()));
